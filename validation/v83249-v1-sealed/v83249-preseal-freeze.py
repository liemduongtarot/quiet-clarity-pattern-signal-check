...
for x in prev:
    ...
    name2,items2=SCENES2[j];scene2=f"In a {name2}, staff independently listed {', '.join(items2)} by cabinet; this separate inventory cannot determine the measured route.";surface=CAT[ci]+' '+CAT2[ci]+' '+scene+' '+scene2+' '+x['surface']+' '+TAIL[j]+' '+TAIL2[j]
