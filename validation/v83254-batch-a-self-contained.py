...
REPO=pathlib.Path.cwd();TARGET='238cdba6ee2d4d17bcde19de2d895a7087983345';SEM='QCEvidenceExtractorV5AY -> QCSemanticCoreV124';SEALED=REPO/'validation/v83254-v1-sealed';WORK=pathlib.Path('/tmp/v83254-batch-a-authority');ROOT='validation/v83254-v1-sealed-runtime'
ATTEMPT=SEALED/'V8_3_254_BATCH_A_ATTEMPT_MARKER.json';FIRST=SEALED/'V8_3_254_SEALED_FIRST_RUN_MARKER.json';RESULT=SEALED/'V8_3_254_BATCH_A_RESULT_V1.json';STATUS=SEALED/'V8_3_254_BATCH_A_STATUS_V1.json'
...
def status(**kw):
 d={'candidate':'V8.3.254','phase':'sealed-batch-a-first-run','run_id':os.environ.get('GITHUB_RUN_ID'),'run_attempt':os.environ.get('GITHUB_RUN_ATTEMPT'),'validated_development_head_sha':TARGET,'semantic_authority':SEM,'batch_b_executed':False,'v253_sealed_rerun':False,'v254_batch_a_rerun':False,'step_111_authorized':False,'production_authorized':False};d.update(kw);STATUS.write_text(json.dumps(d,indent=2)+'\n');return d
def checkpoint():
 z=REPO/'PSC_V8_3_254_V1_BATCH_A_CHECKPOINT.zip'
 if z.exists():z.unlink()
 with zipfile.ZipFile(z,'w',zipfile.ZIP_DEFLATED) as q:
  for n in ['V8_3_254_BATCH_A_RESULT_V1.json','V8_3_254_BATCH_A_STATUS_V1.json','V8_3_254_BATCH_A_ATTEMPT_MARKER.json','V8_3_254_SEALED_FIRST_RUN_MARKER.json','V8_3_254_SEALED_AUTHORITY_V1.json','V8_3_254_PRESEAL_DIVERSITY_AUDIT_V1.json','V8_3_254_SEALED_SELECTION_V1.json','V8_3_254_SEALED_FIXTURE_V1.json','V8_3_254_INDEPENDENT_GOLD_V1.json','V8_3_254_SEALED_MEMBERSHIP_V1.json','V8_3_254_TRANSPORT_VERIFICATION_V1.json','V8_3_254_STATIC_SEALED_PREFLIGHT_V1.json','V8_3_254_BATCH_A_RESERVATION_V1.json','V8_3_254_BATCH_A_CASE_PROVENANCE_V1.json','V8_3_254_BATCH_A_EXECUTION_LEDGER_V1.json','V8_3_254_SEMANTIC_FINGERPRINTS_V1.json','V8_3_254_CONTAMINATION_DUPLICATE_AUDIT_V1.json','V8_3_254_EVIDENCE_PROVENANCE_CONTRACT_COPY_V1.json','V8_3_254_SEMANTIC_SOURCE_IDENTITY_REPORT_V1.json','V8_3_254_RUNTIME_CONFIG_SCHEMA_MANIFEST_V1.json']:
   p=SEALED/n
   if p.exists():q.write(p,p.name)
 (REPO/'PSC_V8_3_254_V1_BATCH_A_CHECKPOINT_SHA256.txt').write_text(fsha(z)+'  '+z.name+'\n')
st=None
try:
 ...
 A=json.loads((SEALED/'V8_3_254_SEALED_AUTHORITY_V1.json').read_text());pf=json.loads((SEALED/'V8_3_254_STATIC_SEALED_PREFLIGHT_V1.json').read_text());tr=json.loads((SEALED/'V8_3_254_TRANSPORT_VERIFICATION_V1.json').read_text())
 ...
 files={'candidate_bank':'V8_3_254_PRESEAL_CANDIDATE_BANK_V1.json','selection':'V8_3_254_SEALED_SELECTION_V1.json','fixture':'V8_3_254_SEALED_FIXTURE_V1.json','independent_gold':'V8_3_254_INDEPENDENT_GOLD_V1.json','membership':'V8_3_254_SEALED_MEMBERSHIP_V1.json','preseal_audit':'V8_3_254_PRESEAL_DIVERSITY_AUDIT_V1.json'}
 ...
 for fn in ['V8_3_254_SEALED_SELECTION_V1.json','V8_3_254_SEALED_FIXTURE_V1.json','V8_3_254_INDEPENDENT_GOLD_V1.json']:shutil.copy2(SEALED/fn,runtime/fn)
