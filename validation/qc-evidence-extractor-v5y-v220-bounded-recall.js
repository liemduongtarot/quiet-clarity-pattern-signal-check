...
function extract(raw){
 ...
 // 1) VI clarification aliases from frozen V219 failure.
 ...
 // 2) VI delegated-decision aliases.
 if(any(d,['hay quyet dinh thay de lua chon cua ban the cho quyen chot cua toi','hay chon phuong an thay toi va de phan doan cua ban thay cho quyet dinh cuoi cua toi'])){
  o.delegated_decision=true;o.agency_transfer_explicit=true;o.choice_object_present=true;o.v220_decision_alias=true;
 }
 // 3) EN hypothetical aliases.
 ...
 // 9) VI neutral-completion aliases.
