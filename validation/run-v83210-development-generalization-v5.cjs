...
src=src.replaceAll("if(!s.QCSemanticCoreV78R)throw new Error('QCSemanticCoreV78R missing');","if(!s.QCSemanticCoreV86)throw new Error('QCSemanticCoreV86 missing');");
src=src.replaceAll("if(!s.QCEvidenceExtractorV1)throw new Error('QCEvidenceExtractorV1 missing');","if(!s.QCEvidenceExtractorV2T)throw new Error('QCEvidenceExtractorV2T missing');");
src=src.replaceAll('s.QCEvidenceExtractorV1.extract','s.QCEvidenceExtractorV2T.extract');
src=src.replaceAll('s.QCSemanticCoreV78R.analyze','s.QCSemanticCoreV86.analyze');
...
src=src.replaceAll('V8.3.209 DEVELOPMENT-ONLY GENERALIZATION AUDIT V1','V8.3.210 DEVELOPMENT-ONLY FRESH GENERALIZATION AUDIT V5');
src=src.replaceAll("semantic_authority:'QCSemanticCoreV78R'","semantic_authority:'QCSemanticCoreV86'");
src=src.replaceAll("extractor:'QCEvidenceExtractorV1-REVIEW-CANDIDATE'","extractor:'QCEvidenceExtractorV2T-V210-CONTEXTUAL-RECALL'");
src=src.replaceAll('V8_3_209_DEVELOPMENT_GENERALIZATION_RESULTS_V1.json','V8_3_210_DEVELOPMENT_GENERALIZATION_RESULTS_V5.json');
const mod={exports:{}};const fn=new Function('require','module','exports','__filename','__dirname',src);fn(require,mod,mod.exports,path.resolve('generated-v83210-generalization-v5.cjs'),process.cwd());
