(function(global){
'use strict';
const parent=global.QCSemanticCoreV82;if(!parent)throw new Error('V8.3.210 V83 requires QCSemanticCoreV82');
const extractor=global.QCEvidenceExtractorV2;if(!extractor)throw new Error('V8.3.210 V83 requires QCEvidenceExtractorV2');
const VERSION='V8.3.210-V83-CENTRALIZED-RELATIONAL-EVIDENCE';
