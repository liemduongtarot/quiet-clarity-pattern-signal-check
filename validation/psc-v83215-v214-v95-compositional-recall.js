(function(global){
'use strict';
const parent=global.QCSemanticCoreV94R;if(!parent)throw new Error('V95 requires V94R');
const stable=global.QCSemanticCoreV86;if(!stable)throw new Error('V95 requires V86');
const extractor=global.QCEvidenceExtractorV5V;if(!extractor)throw new Error('V95 requires V5V');
const VERSION='V8.3.215-V95-COMPOSITIONAL-RECALL';
