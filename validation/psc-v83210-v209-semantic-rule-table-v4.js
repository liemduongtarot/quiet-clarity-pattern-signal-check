(function(global){
'use strict';
const parent=global.QCSemanticCoreV80;if(!parent)throw new Error('V8.3.210 V81 requires QCSemanticCoreV80');
const extractor=global.QCEvidenceExtractorV1R3;if(!extractor)throw new Error('V8.3.210 V81 requires QCEvidenceExtractorV1R3');
const VERSION='V8.3.210-V81-SEMANTIC-EVIDENCE-RULE-TABLE';
