(function(global){
'use strict';
const parent=global.QCSemanticCoreV83;if(!parent)throw new Error('V8.3.210 V84 requires QCSemanticCoreV83');
const extractor=global.QCEvidenceExtractorV2R;if(!extractor)throw new Error('V8.3.210 V84 requires QCEvidenceExtractorV2R');
const VERSION='V8.3.210-V84-MULTILINGUAL-RELATIONAL-EVIDENCE';
