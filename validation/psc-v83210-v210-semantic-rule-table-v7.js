(function(global){
'use strict';
const parent=global.QCSemanticCoreV84;if(!parent)throw new Error('V8.3.210 V85 requires QCSemanticCoreV84');
const extractor=global.QCEvidenceExtractorV2S;if(!extractor)throw new Error('V8.3.210 V85 requires QCEvidenceExtractorV2S');
const VERSION='V8.3.210-V85-CONTEXT-SANITIZED-RELATIONAL-EVIDENCE';
