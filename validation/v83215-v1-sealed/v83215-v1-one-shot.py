...
# Update the inherited V8.3.214 wrapper's own audit assertion so it matches the promoted previous-sealed field.
src=src.replace('assert "v213_sealed_rerun" in src','assert "v214_sealed_rerun" in src')
